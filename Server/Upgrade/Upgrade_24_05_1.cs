...
public class Upgrade_24_05_1 : UpgradeBase
{
    ...
    public Upgrade_24_05_1(FileFlows.Plugin.ILogger logger, AppSettingsService settingsService, UpgradeManager upgradeManager)
    ...
    public void Run()
    {
        var service = new DockerModService();
        service.Save(dmFFmpeg(), null).Wait();
        service.Save(dmRar(), null).Wait();
    }
